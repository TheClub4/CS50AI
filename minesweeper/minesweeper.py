    ...
    def add_knowledge(self, cell, count):
        ...
        for i in range(len(self.knowledge)):
            for j in range(i+1, len(self.knowledge)):
                si = self.knowledge[i]
                sj = self.knowledge[j]
                if sj.cells.issubset(si.cells):
                    cells = si.cells - sj.cells
                    s = Sentence(si.cells - sj.cells, si.count - sj.count)

                    if s not in self.knowledge:
                        self.knowledge.append(s)

                elif si.cells.issubset(sj.cells):
                    cells = si.cells - sj.cells
                    s = Sentence(sj.cells - si.cells, sj.count - si.count)
